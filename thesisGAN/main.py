...
parser = argparse.ArgumentParser(description='Logging Parameters')
parser.add_argument('-name','--wb_name', default="trial", type=str, help='WandB Run Name', required=False)
parser.add_argument('-desc', '--wb_desc', default="Trial runs", type=str, help='WandB Run Description', required=False)
...
#Initialize WandB
wandb.init(project="masterthesis", entity="dhc_research", name= args.wb_name, notes=args.wb_desc, dir="../")
